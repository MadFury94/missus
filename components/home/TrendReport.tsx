...
export default function TrendReport() {
    return (
        <div style={{ padding: "24px 20px" }}>
            <h2 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "22px", fontWeight: 800, letterSpacing: ".06em", textTransform: "uppercase", marginBottom: "16px", borderLeft: "4px solid #7F0E12", paddingLeft: "12px" }}>
                THE TREND REPORT
            </h2>
