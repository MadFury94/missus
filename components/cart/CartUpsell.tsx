                        ...
                        <Link href={`/product/${product.slug}`} style={{ display: "block", textDecoration: "none" }}>
                            <div style={{ aspectRatio: "2/3", background: "#f0ece8", position: "relative", overflow: "hidden", marginBottom: "6px" }}>
                                {product.image ? (
                                    ...
                                    <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "var(--font-barlow-condensed)", fontSize: "10px", fontWeight: 700, letterSpacing: ".08em", textTransform: "uppercase", color: "rgba(0,0,0,.2)", textAlign: "center", padding: "8px", lineHeight: 1.4 }}>
                                        {product.name}
                                    </div>
                                )}
