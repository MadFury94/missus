                ...
                <div style={{ minWidth: 0 }}>
                    ...
                    {!loading && products.length === 0 && (
                        <div style={{ padding: "80px 20px", textAlign: "center" }}>
                            ...
                            <button onClick={() => setFilters({ perPage: 60 })} style={{ borderRadius: "999px", background: "#000", color: "#fff", fontFamily: "'Barlow Condensed', sans-serif", fontSize: "13px", fontWeight: 700, letterSpacing: ".1em", textTransform: "uppercase", padding: "14px 32px", border: "none", cursor: "pointer" }}>
                                Clear Filters
                            </button>
                        </div>
                    )}
